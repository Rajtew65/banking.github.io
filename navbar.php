<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #C0392B;"><b>RT Bank of India</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="createuser.php" style="color : #C0392B;"><b> New Register</b></a>
              </li>
              <li class="nav-item">
