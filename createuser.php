...
?>
  ...
  <div class="container">
    <div class="screen">
      ...
      <div class="screen-body" style="background-color: #b3ff99" >
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
              <input class="app-form-control" placeholder="BALANCE" type="number" name="balance" autocomplete="off" required>
            </div>
            <br>
...
<footer class="text-center mt-5 py-2 " style="color: black;">
            <p>&copy 2021. Made by <b>RAJESH TEWARI</b> <br> RAJESH TEWARI PVT.LTD</p>
</footer>
